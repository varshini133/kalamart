      ...
      >
        <div className="h-16 max-w-md mx-auto px-2 flex items-center justify-around">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center min-w-[56px] min-h-[48px] transition-all active:scale-95 ${
          ...
          <button
            ...
            className="flex flex-col items-center justify-center min-w-[60px] min-h-[48px] -mt-5 group"
          >
            <div
          ...
          <button
            ...
            className={`relative flex flex-col items-center justify-center min-w-[56px] min-h-[48px] transition-all active:scale-95 ${
    ...
    >
      <div className="h-16 max-w-md mx-auto px-2 flex items-center justify-around">
        ...
        <button
          type="button"
          onClick={onOpenCart}
          className="relative flex flex-col items-center justify-center min-w-[56px] min-h-[48px] transition-all active:scale-95 text-on-surface-variant hover:text-primary"
        >
